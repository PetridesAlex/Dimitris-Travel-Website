...
export const ROLE_PERMISSIONS: Record<UserRole, Permission[]> = {
  super_admin: [
    'users.manage', 'settings.manage', 'content.create', 'content.edit',
    'content.publish', 'content.delete', 'media.upload', 'media.delete',
    'blog.manage', 'enquiries.view', 'enquiries.assign', 'enquiries.export', 'seo.manage',
  ],
  admin: [
    'settings.manage', 'content.create', 'content.edit', 'content.publish',
    'content.delete', 'media.upload', 'media.delete', 'blog.manage',
    'enquiries.view', 'enquiries.assign', 'enquiries.export', 'seo.manage',
  ],
  editor: [
    'content.create', 'content.edit', 'content.publish', 'media.upload',
    'blog.manage', 'enquiries.view', 'seo.manage',
  ],
  content_writer: ['content.create', 'content.edit', 'media.upload', 'blog.manage'],
